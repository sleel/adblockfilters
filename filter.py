...
class Filter(object):
    ...
    def __generateFilter(self, filterSet:Set[str], whiteSet:Set[str], fileName:str):
        ...
        with open(fileName, 'a') as f:
            ...
            f.write("! Description: 适用于AdGuard的去广告合并规则，每8个小时更新一次。规则源：AdGuard Base filter、AdGuard Tracking Protection filter、AdGuard URL Tracking filter、AdGuard Chinese filter、anti-AD、CJX's Annoyance List、xinggsf mv、jiekouAD\n")
            f.write("! Homepage: https://github.com/sleel/adblockfilters\n")
